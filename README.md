...
| | จูน PID | จูน KP (ปิด KD) · จูน KD · จูน KP (คง KD) · วัดการส่าย · ค่าความไวตอนนี้ |
...
KrathokKidsBit.lineSetupStandard()
KrathokKidsBit.lineCalibrate()
KrathokKidsBit.lineTuneKpNoKd(40, 0.02, 0.2)
KrathokKidsBit.lineTuneKd(40, 0, 8)
KrathokKidsBit.lineTuneKpWithKd(40, 0.02, 0.4)
```
...
| `ค่าความไวตอนนี้ (KP/KD)` | อ่านค่าที่จูนได้ไปจดไว้ ครั้งหน้าใส่ผ่าน `ปรับความไวเดินตามเส้น` ได้เลย |
...
>
> **KD เพิ่มตามความเร็ว ไม่ใช่ลดลง** จูนแยกทีละช่วงความเร็วที่จะใช้จริง อย่าคำนวณจากสูตร
