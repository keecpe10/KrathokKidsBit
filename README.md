...
| บรรทัด | ความหมาย |
| --- | --- |
| `ADC` | ชิป ADS7828 อ่านเซ็นเซอร์เส้น ไล่หาครบ 0x48-0x4B (ตั้งได้ด้วยขา A0/A1) |
...
| `ADC 0x49 NOT 0x48` | เจอชิปแต่**คนละที่อยู่**กับที่โค้ดใช้อยู่ ค่าที่อ่านได้จะไม่ถูกต้อง ต้องแก้ที่อยู่ในโค้ดก่อน |
