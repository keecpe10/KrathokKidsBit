...
| **เดินตามเส้น** | ตั้งค่าเส้น | ตั้งค่าเซ็นเซอร์เส้น แบบมาตรฐาน · สอนเซ็นเซอร์รู้จักเส้นและพื้น · ตั้งค่าเซ็นเซอร์ช่อง _ · ตั้งค่าเซ็นเซอร์ทุกช่อง · ค่าคาลิเบรตช่อง _ · ใช้เส้นแบบ _ · ไฟเซ็นเซอร์เส้น เปิด/ปิด · ปรับความไว KP/KD |
...
**วิธีหาค่าที่จะใส่** — สอนเซ็นเซอร์หนึ่งครั้ง แล้วอ่านค่ากลับมาจดไว้
